...
def Init_BPM():
    #?? ???
    global p_adc, e_adc
    global ppg_peaks, ppg_count_bpm, ppg_avg_bpm, ppg_tot_bpm, ppg_filtered_bpm, ppg_count_zero_bpm, ppg_bpm_level
    global ecg_peaks, ecg_count_bpm, ecg_avg_bpm, ecg_tot_bpm, ecg_filtered_bpm, ecg_count_zero_bpm, ecg_bpm_level
...
def Get_Values_For_Monitor_Sensor(sensor_type, channel):
    global p_adc, ppg_peaks, ppg_count_bpm, ppg_avg_bpm, ppg_tot_bpm, ppg_filtered_bpm, ppg_count_zero_bpm, ppg_bpm_level
    global e_adc, ecg_peaks, ecg_count_bpm, ecg_avg_bpm, ecg_tot_bpm, ecg_filtered_bpm, ecg_count_zero_bpm, ecg_bpm_level
    
    if sensor_type == "PPG":
        value = p_adc.Read(channel)
        return value, ppg_peaks, ppg_count_bpm, ppg_avg_bpm, ppg_tot_bpm, ppg_filtered_bpm, ppg_count_zero_bpm, ppg_bpm_level
    
    elif sensor_type == "ECG":
        value = e_adc.Read(channel)
        return value, ecg_peaks, ecg_count_bpm, ecg_avg_bpm, ecg_tot_bpm, ecg_filtered_bpm, ecg_count_zero_bpm, ecg_bpm_level
    
    
# Setting Value : Peak, BPM
def Set_Values_After_Monitor_Sensor(sensor_type, peaks, count_bpm, avg_bpm, tot_bpm, filtered_bpm, count_zero_bpm, bpm_level):
    global ppg_peaks, ppg_count_bpm, ppg_avg_bpm, ppg_tot_bpm, ppg_filtered_bpm, ppg_count_zero_bpm, ppg_bpm_level
    global ecg_peaks, ecg_count_bpm, ecg_avg_bpm, ecg_tot_bpm, ecg_filtered_bpm, ecg_count_zero_bpm, ecg_bpm_level
    ...
    if sensor_type == "PPG":
        ...
        ppg_count_zero_bpm = count_zero_bpm
        ...
        ecg_count_zero_bpm = count_zero_bpm
